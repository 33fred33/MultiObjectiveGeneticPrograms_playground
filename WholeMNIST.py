...
parser.add_argument("-p",
                    ...
                    #default="CIFAR",
                    type=str,
                    help="problem to be solved: pedestrian, pedestrian_old, MNIST, symbollic_regression, CIFAR")
...
for digit in range(10):
    ...
    for run in range(args.runs):
        ename = args.experiment_name + "/digit" + str(digit)
    ...
    with open(ename + "results_file.csv", mode = "w") as f:
    ...
    with open(ename + "results_by_run.csv", mode='w') as last_file:
